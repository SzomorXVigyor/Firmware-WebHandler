            ...
            <div class="row">
                <div class="col-12 text-center">
                    <div class="hero-section py-5">
                        ...
                        <h1 class="display-4 mb-3 mx-4">Firmware Management Server</h1>
                        <p class="lead mb-4 mx-4">Secure firmware distribution and version management system</p>
                        <div class="row justify-content-center">
                            <div class="col-md-10 col-lg-8">
                                <div class="row">
                                    <div class="col-12 col-md-4 mb-3 px-4">
                                        <div class="card h-100 text-center d-flex card-fixed-min-width">
                                    ...
                                    <div class="col-12 col-md-4 mb-3 px-4" id="uploadCard">
                                        <div class="card h-100 text-center d-flex card-fixed-min-width">
                                            <div class="card-body d-flex flex-column">
